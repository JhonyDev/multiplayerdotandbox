...
public class BoardView extends View {
    ...
    private void init() {
        ...
        linePaint.setColor(ContextCompat.getColor(getContext(), R.color.player1));
    ...
    public void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < board.getRows(); i++) {
            ...
            for (int j = 0; j < board.getColumns(); j++) {
                ...
                linePaint.setColor(ContextCompat.getColor(getContext(), R.color.player1));
//                if (GameFragment.isMyTurn)
//                else
//                    linePaint.setColor(ContextCompat.getColor(getContext(), R.color.player2));
                ...
                if (box.top) {
                    ...
                    if (GameFragment.dataList != null) {
                        boolean isFound = false;
                        for (Data data : GameFragment.dataList) {
                            Log.i("TAG", "***************: " + data.x1);
                            Log.i("TAG", "***************: " + data.x2);
                            Log.i("TAG", "***************: " + data.y1);
                            Log.i("TAG", "***************: " + data.y2);
                            if ((x1 / boxSide) == data.x1
                                    & (x2 / boxSide) == data.x2
                                    & (y1 / boxSide) == data.y1
                                    & (y2 / boxSide) == data.y2) {
                                isFound = true;
                                Log.i("TAG", "onDraw: FOUND YAHOOOOOOOOOOOOOOOOOOOOOO");
                                break;
                            }
                        }
                        if (isFound)
                    ...
                    Log.i("TAG", "onDraw: " + (x1 / boxSide));
                    Log.i("TAG", "onDraw: " + (x2 / boxSide));
                    Log.i("TAG", "onDraw: " + (y1 / boxSide));
                    Log.i("TAG", "onDraw: " + (y2 / boxSide));
                    Log.i("TAG", "onDraw: -----------------------------------");
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                deltaX = Math.min(deltaXLeft, deltaXRight);
                deltaY = Math.min(deltaYDown, deltaYUp);
            ...
            case MotionEvent.ACTION_UP:
                ...
                Log.i("TAG", "onTouchEvent: " + (int) x1temp);
                Log.i("TAG", "onTouchEvent: " + (int) x2temp);
                Log.i("TAG", "onTouchEvent: " + (int) y1temp);
                Log.i("TAG", "onTouchEvent: " + (int) y2temp);


                if (GameFragment.dataList != null) {
                    GameFragment.dataList.add(new Data(
                            (int) x1temp,
                            (int) x2temp,
                            (int) y1temp,
                            (int) y2temp
    ...
    public void setTurnMe(boolean turnMe) {
        ...
        Log.i("TAG", "setTurnMe: My Turn : " + turnMe);
